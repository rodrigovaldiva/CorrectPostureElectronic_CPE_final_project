...
void loop() {
  ...
  if (standard == 361) {
    ...
    if (M5.BtnA.wasPressed() || M5.BtnB.wasPressed() || M5.BtnC.wasPressed()) {
      standard=roll; //store current “roll” value from IMU sensor into “standard” variable and print the same
      M5.Lcd.setCursor(0,100);
    ...
    if(roll<(standard+12) && roll>(standard-30)){
  ...
  //resetting of real-time counter within M5Stack 
    ...
    //perform vibration and output a beep sound 
  ...
  delay(10); //ensures delay (of 10ms) between runnings of loop
 }
